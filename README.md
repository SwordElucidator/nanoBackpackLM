...
The simplest repository for training/finetuning medium-sized Backpacks inspired by [nanoGPT](https://github.com/karpathy/nanoGPT).
...
## quick start (Follow the nanoGPT instruction; TODO in future)
